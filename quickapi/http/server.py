...
async def not_found(req: Request) -> HttpResponse:
    return HttpResponse("404, Not Found!", Status.NotFound)
...
class HTTPServer:
    ...
    port: int = 8080
    backlog: int = 100
    app: Callable[[Request], Awaitable[HttpResponse]] = not_found
        ...
        async with connection:
            ...
            while True:
                ...
                try:
                    ...
                    print(e)
                    response = HttpResponse(f"500 Internal Server Error: {e}", Status.InternalServerError)
